...
there are solutions to the 2nd edition of the book at https://github.com/ohkimur/the-c-programming-language-2nd-edition-solutions

there are solutions to the exercises that use C99 features: https://github.com/ptdecker/cbasics

the 2nd edition is availabe in html at <https://zedware.github.io/homepage/code/tcpl/index.html> with additional prefaces from "zedware"
...
The 2nd edition of the book is available online

* Google search: the c programming language second edition
  * <https://archive.org/details/c-programming-language-2nd-edition>
  * leaked by some universities:
    * <https://www.emgywomenscollege.ac.in/templateEditor/kcfinder/upload/files/C_Programming.pdf> (Clean, Links TOC)
    * <http://www.cs.emory.edu/~cheung/Courses/255/Syllabus/1-C-intro/Docs/C-book.pdf> (OCR)
    * <https://www.cs.sfu.ca/~ashriram/Courses/CS295/assets/books/C_Book_2nd.pdf> (Clean)

* Google search: the c programming language first edition
  * leaked by some universities:
    * <https://www.cimat.mx/ciencia_para_jovenes/bachillerato/libros/%5BKernighan-Ritchie%5DThe_C_Programming_Language.pdf> (Clean, TOC has links)
    * <https://courses.physics.ucsd.edu/2014/Winter/physics141/Labs/Lab1/The_C_Programming_Language.pdf> (Clean, TOC has links)

* based on the Clean version, google search: "ISBN 0-13-110370-9" filetype:pdf
